...
% Legal options: 'data' or 'residual'
fitting_options.bootstrap_method = 'residual';

% Legal options: Nonnegative integer
fitting_options.number_of_bootstraps = 10;
...
experiment_data = load_experiment_data( 'West_and_Post_data_species_2.mat' );
